...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This link is use to redirect when necessary
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Link to redirect for mobile app
    |--------------------------------------------------------------------------
    |
    | This link is use to redirect when calling from mobile app
    |
    */

    'mobile_scheme' => env('MOBILE_SCHEME'),
